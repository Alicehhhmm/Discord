...
export const NavigationSidebar = async () => {
    ...
    return (
        <div className='space-y-4 flex flex-col items-center h-full w-full text-primary bg-[#E3E4E5] dark:bg-[#1E1F22] py-3'>
            <NavigationAction />
            <Separator className='h-[2px] bg-zinc-300 dark:bg-zinc-700 rounded-md w-10 max-auto' />
            <ScrollArea className='flex-1 w-full space-y-2'>
                {servers.map(server => (
